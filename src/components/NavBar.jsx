...
export default function NavBar() {
	...
	return (
		<header className="z-[999] relative w-full">
			<div className="fixed top-0 -translate-x-1/2 left-1/2 h-[4.5rem]  w-full rounded-none border border-white border-opacity-40 bg-white bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] md:top-6 md:h-[3.25rem] md:w-[45rem] md:rounded-full dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75"></div>
